...
urlpatterns = [
    ...
    path('moderator/pending-approval/', user_views.moderator_pending_approval, name='moderator_pending_approval'),
    ...
    path('admin-panel/approvals/<int:approval_id>/inspect/', admin_views.buyer_inspection_detail, name='buyer_inspection_detail'),
    path('admin-panel/approvals/<int:approval_id>/moderator/', admin_views.moderator_inspection, name='moderator_inspection'),
